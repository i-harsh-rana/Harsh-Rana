            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">harshrana8454@gmail.com</span>

                        <a href="mailto:harshrana8454@gmail.com" className="contact__button">Write me{" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    ...
                    <div className="contact__card">
                        ...
                        <a href="https://wa.me/917351758454?text=Hello" className="contact__button">Write me{" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
