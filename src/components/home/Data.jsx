...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Harsh Rana
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Hi, I'm a passionate full-stack web developer with expertise in modern web technologies.</p>
